...
namespace ConversationBuilder.Data.Cosmos
{
	...
	{
		public ArmLocationData(Container container) : base(container, RootPartition.ArmLocation, "created", "name") { }

		public async Task<ArmLocation> GetAsync(string id)
		{
			return await base.GetAsync<ArmLocation>(id);
		}
		
		public async Task UpdateAsync(ArmLocation data)
		{
			await base.UpdateAsync<ArmLocation>(data);
		}

		public async Task<ItemResponse<ArmLocation>> AddAsync(ArmLocation data)
		{
			return await base.AddAsync<ArmLocation>(data);
		}
