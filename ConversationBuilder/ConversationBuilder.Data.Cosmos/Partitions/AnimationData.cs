...
namespace ConversationBuilder.Data.Cosmos
{
	...
	{
		public AnimationData(Container container) : base(container, RootPartition.Animation, "created", "name") { }

		public async Task<Animation> GetAsync(string id)
		{
			return await base.GetAsync<Animation>(id);
		}
		
		public async Task UpdateAsync(Animation data)
		{
			await base.UpdateAsync<Animation>(data);
		}

		public async Task<ItemResponse<Animation>> AddAsync(Animation data)
		{
			return await base.AddAsync<Animation>(data);
		}
