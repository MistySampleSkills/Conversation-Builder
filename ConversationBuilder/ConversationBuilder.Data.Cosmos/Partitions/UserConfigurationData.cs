...
namespace ConversationBuilder.Data.Cosmos
{
	...
	{
		public UserConfigurationData(Container container) : base(container, RootPartition.UserConfiguration, "created", "name") { }

		public async Task<UserConfiguration> GetAsync(string id)
		{
			return await base.GetAsync<UserConfiguration>(id);
		}
		
		public async Task UpdateAsync(UserConfiguration data)
		{
			await base.UpdateAsync<UserConfiguration>(data);
		}

		public async Task<ItemResponse<UserConfiguration>> AddAsync(UserConfiguration data)
		{
			return await base.AddAsync<UserConfiguration>(data);
		}
