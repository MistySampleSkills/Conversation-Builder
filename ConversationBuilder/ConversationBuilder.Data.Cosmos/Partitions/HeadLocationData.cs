...
namespace ConversationBuilder.Data.Cosmos
{
	...
	{
		public HeadLocationData(Container container) : base(container, RootPartition.HeadLocation, "created", "name") { }

		public async Task<HeadLocation> GetAsync(string id)
		{
			return await base.GetAsync<HeadLocation>(id);
		}
		
		public async Task UpdateAsync(HeadLocation data)
		{
			await base.UpdateAsync<HeadLocation>(data);
		}

		public async Task<ItemResponse<HeadLocation>> AddAsync(HeadLocation data)
		{
			return await base.AddAsync<HeadLocation>(data);
		}
