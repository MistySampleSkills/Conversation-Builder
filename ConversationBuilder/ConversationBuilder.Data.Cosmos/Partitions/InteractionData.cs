...
namespace ConversationBuilder.Data.Cosmos
{
	...
	{
		Task<int> GetCountAsync(string conversationId);
		Task<Interaction> GetAsync(string id);
	...
	{
		public InteractionData(Container container) : base(container, RootPartition.Interaction, "created", "name") { }

		public async Task<Interaction> GetAsync(string id)
		{
			return await base.GetAsync<Interaction>(id);
		}
		
		public async Task UpdateAsync(Interaction data)
		{
			await base.UpdateAsync<Interaction>(data);
		}

		public async Task<ItemResponse<Interaction>> AddAsync(Interaction data)
		{
			return await base.AddAsync<Interaction>(data);
		}
		...
		{
			return (await base.GetCountAsync(conversationId));
		}
	}
}