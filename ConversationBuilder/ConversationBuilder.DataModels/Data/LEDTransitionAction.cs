...
namespace ConversationBuilder.DataModels
{
	...
	public class LEDTransitionAction : IEditableData
	{
		...
		public string ItemType { get; set; } = DataItemType.LEDTransitionAction.ToString();

		/// <summary>
		/// 0-255 Red value
		/// </summary>
		[Display(Name = "Starting Red RGB value")]
		public byte Red { get; set; }

		/// <summary>
		/// 0-255 Green value
		/// </summary>
		[Display(Name = "Starting Green RGB value")]
		public byte Green { get; set; }

		/// <summary>
		/// 0-255 Blue value
		/// </summary>
		[Display(Name = "Starting Blue RGB value")]
		public byte Blue { get; set; }

		/// <summary>
		/// 0-255 Red value
		/// </summary>
		[Display(Name = "Ending Red RGB value")]
		public byte Red2 { get; set; }

		/// <summary>
		/// 0-255 Green value
		/// </summary>
		[Display(Name = "Ending Green RGB value")]
		public byte Green2 { get; set; }

		/// <summary>
		/// 0-255 Blue value
		/// </summary>
		[Display(Name = "Ending Blue RGB value")]
