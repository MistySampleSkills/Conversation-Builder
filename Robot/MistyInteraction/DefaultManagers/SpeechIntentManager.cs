...
namespace MistyInteraction
{
	public sealed class SpeechIntentManager : ISpeechIntentManager
	{
		...
		public SpeechIntentManager(IRobotMessenger robot, IDictionary<string, UtteranceData> utteranceLists)
		{
			_misty = robot;
			_intentInterpreter = new SpeechIntentInterpreter(utteranceLists);
		}
