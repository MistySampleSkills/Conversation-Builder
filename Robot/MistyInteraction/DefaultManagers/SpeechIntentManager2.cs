...
{
	public sealed class SpeechIntentManager2 : ISpeechIntentManager
	{
		private IRobotMessenger _misty;
		private SpeechIntentInterpreter _intentInterpreter;
		
		public SpeechIntentManager2(IRobotMessenger robot, IDictionary<string, UtteranceData> utteranceLists, IList<GenericDataStore> userData = null)
		{
			_misty = robot;			
			_intentInterpreter = new SpeechIntentInterpreter2(utteranceLists, userData);
		}
