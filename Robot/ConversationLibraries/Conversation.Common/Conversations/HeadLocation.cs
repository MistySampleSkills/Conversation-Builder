...
namespace Conversation.Common
{
	public class HeadLocation
	{
		...
		public HeadLocation(double? minPitch, double? minRoll, double? minYaw, double? maxPitch = null, double? maxRoll = null, double? maxYaw = null, double? movementDuration = null, int? movementVelocity = null)
		{
			MinPitch = minPitch;
			MinRoll = minRoll;
			MinYaw = minYaw;
