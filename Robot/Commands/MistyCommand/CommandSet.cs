...
{
	public abstract class CommandSetCC
	{
		...
		protected SpeechManager SpeechManager { get; set; }

		public IList<ConversationCommand> Commands { get; set; } = new List<ConversationCommand>();

		public CommandSet(string name, IRobotMessenger misty, IDictionary<string, object> parameters, CharacterParameters characterParameters, SpeechManager speechManager)
		{
			Name = name;
